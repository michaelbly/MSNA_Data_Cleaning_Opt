...
df <-  read_excel("input/raw_data/FINAL_Pilot_V12_REACH_oPt_Kobo_MSNA_June_2021_13062021_2021-06-20-05-33-16.xlsx")
...
*Surveys with less Than  40 mins*
```{r}
duration_less_30 <- today_df %>% 
  filter(today_df$consent == "yes" & interview_duration <= 40) %>% 
  dplyr::select(enumerator_num,interview_duration)
duration_less_30
```
